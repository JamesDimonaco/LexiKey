          ...
          <div className="prose prose-gray dark:prose-invert max-w-none">
            <section className="mb-8">
              ...
              <p className="text-gray-700 dark:text-gray-300 mb-4">
                By accessing or using LexiKey ("the Service"), you agree to be
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 dark:text-gray-300 mb-4">
                LexiKey is a literacy intervention tool that uses touch-typing
                muscle memory to reinforce phonics and spelling. The Service
                provides adaptive typing practice designed to support learners,
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 dark:text-gray-300 mb-4">
                You may use LexiKey anonymously or create an account. When you
                create an account:
              </p>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 dark:text-gray-300 mb-4">
                ...
                functionality are owned by LexiKey and are protected by
                international copyright, trademark, patent, trade secret, and
                other intellectual property laws.
              </p>
              <p className="text-gray-700 dark:text-gray-300 mb-4">
                You retain ownership of any data you create or input into the
                Service. By using the Service, you grant us a license to use,
                store, and process your data as necessary to provide the
                Service.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 dark:text-gray-300 mb-4">
                You are responsible for any content you create or submit through
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 dark:text-gray-300 mb-4">
                LexiKey is an educational tool and does not provide medical,
                therapeutic, or professional advice. Results may vary, and we
                make no guarantees about learning outcomes.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 dark:text-gray-300 mb-4">
                TO THE MAXIMUM EXTENT PERMITTED BY LAW, LEXIKEY SHALL NOT BE
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 dark:text-gray-300 mb-4">
                ...
                through the settings page or contacting us.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 dark:text-gray-300 mb-4">
                ...
                contact us through your preferred method or visit our GitHub
                repository.
              </p>
            </section>
          </div>
